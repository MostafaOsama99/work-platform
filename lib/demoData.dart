...
List<Message> messagesList = [
  Message(dateTime: DateTime.now().subtract(Duration(hours: 12)), isMe: true, message: "Hello", senderName: "test"),
  Message(
      dateTime: DateTime.now().subtract(Duration(hours: 6)),
      isMe: false,
      message: "How are you ?,How are you ?How are you ?How are you ?How are you ?How are you ?How are you ?How are you ?How are you ?How are you ?How are you ?How are you ?",
      senderName: "test"),
  Message(dateTime: DateTime.now().subtract(Duration(minutes: 22)), isMe: true, message: "fine, thanks", senderName: "test"),
  Message(dateTime: DateTime.now(), isMe: false, message: "your progress is amazing this week", senderName: "test"),
  Message(dateTime: DateTime.now(), isMe: false, message: "your progress ", senderName: "test"),
  Message(dateTime: DateTime.now(), isMe: true, message: "i do my best", senderName: "test"),
  Message(
...
List<Project> project = [
  Project(projectName: "Hr Company", startDate: DateTime(2020, 12, 1), endDate: DateTime(2021, 1, 18), mangerName: "Mostafa osama", description: longDescription, teams: [
    Teams(
        tasks: demoTasks,
