...
import 'package:project/screen/auth/signUp.dart';
import 'package:project/screen/edit_team_screen.dart';
import 'package:project/screen/join_or_create_team.dart';
import 'package:project/screen/main_screen/profile_screen.dart';
import 'package:project/screen/navigation/single_task_view.dart';
import 'package:project/screen/navigation/project_view.dart';
import 'screen/navigation/app.dart';
import 'package:project/screen/navigation/room_screen.dart';
import 'package:project/screen/navigation/profile_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        darkTheme: ThemeData(
            ...
            //Colors.white,
            accentIconTheme:
                IconThemeData(color: Color.fromRGBO(33, 230, 193, 1)),
