...
class _TeamSettingsState extends State<TeamSettings> {
  ...
  Widget build(BuildContext context) {
    ...
    addTeam() async {
      ...
      await handleRequest(
          () => teamProvider.createTeam(roomId, _teamName, _teamDescription),
          context);
    ...
    updateTeam({String name, String description}) async {
      setState(() => _isLoading = true);
      await handleRequest(
          () => teamProvider.updateTeam(name, description), context);
      setState(() => _isLoading = false);
    }
    ...
    return Scaffold(
            ...
            child: Stack(
              ...
              children: [
                AppBar(
                  ...
                  title: Text(_isLeader
                      ? 'Edit ${teamProvider.team.name}'
      ...
      body: ListView(
        ...
        children: [
          EditableTextWidget(teamProvider.team.name,
              title: 'Team Name',
              onChanged: (value) => updateTeam(name: value),
              enableEdit: _isLeader,
              maxLines: 1),
          Divider(height: 16, indent: 5, endIndent: 5),
          EditableTextWidget(teamProvider.team.description,
              onChanged: (desc) => updateTeam(description: desc),
              enableEdit: _isLeader),
          Divider(height: 16, indent: 5, endIndent: 5),
          ...
          */
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                          teamProvider.team.code.substring(0, 15) + '...',
                ...
                IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      onShare(context,
                          "Your are invited to join my ${teamProvider.team.name} team \nKindly use this code to join: ${teamProvider.team.code}");
                    });
                  },
                  splashRadius: 18,
                )
          ...
          creatorTile(teamProvider.team.leader, 'Team Leader'),
          ...users,
          Divider(height: 16, indent: 5, endIndent: 5),
          ...
          Form(
            ...
            child: custom.ExpansionTile(
              ...
              children: [
                ...
                if (_teamDescriptionError.isNotEmpty)
                  errorMessage(_teamDescriptionError),
                SizedBox(
                    height: 48,
                    child: FittedBox(
                        child: addTeamsButton(
                            hintText: "Create Team", onPressed: addTeam))),
              ],
            ),
          ),
        ],
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            radius: 22,
            child: Text(user.name[0] + user.name[lastLitter],
...
Widget creatorTile(User user, String epithet) {
  var lastLitter = user.name.indexOf(' ') + 1;
  return GestureDetector(
    onLongPress: () {
      //TODO: show popup menu
